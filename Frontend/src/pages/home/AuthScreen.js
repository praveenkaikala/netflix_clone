...
import tvVideo from "../../assets/hero-vid.m4v"
import strangerThings1 from "../../assets/stranger-things-lg.png" 
import strangerThings2 from "../../assets/stranger-things-sm.png"
import kids from "../../assets/kids.png"
import device from "../../assets/device-pile.png"
import devicevid from "../../assets/video-devices.m4v"
...
const AuthScreen = () => {
  return (
    <div className="hero-bg  relative">
      ...
      <div className="bg-black text-white">
        <div className="flex flex-col md:flex-row justify-center items-center px-4 md:px-2 mx-auto max-w-6xl">
      ...
      <div className='py-10 bg-black text-white'>
				<div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
					...
					<div className='flex-1 relative'>
						<div className='relative'>
							<img src={strangerThings1} alt='Stranger Things img' className='mt-4' />
              ...
              '
							>
								<img src={strangerThings2} alt='image' className='h-full' />
            ...
            <div className='py-10 bg-black text-white'>
				<div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
					...
					<div className='flex-1 relative overflow-hidden'>
						<img src={device} alt='Device image' className='mt-4 z-20 relative' />
						<video
  ...
  <h3 className=" font-bold">Created By Praveen Kumar Kaikala</h3>

  <a href="mailto:kaikalapraveen24@gmail.com" className="flex justify-center items-center gap-1 cursor-pointer">
    <MdEmail />
    <p className="font-semibold animate-pulse">Email</p>
  </a>

  <a href="https://linkedin.com/in/praveenkaikala" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center gap-1 cursor-pointer">
    <FaLinkedin />
    <p className="font-semibold animate-pulse">LinkedIn</p>
  </a>

  <a href="https://github.com/praveenkaikala" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center gap-1 cursor-pointer">
    <FaSquareGithub />
    <p className="font-semibold animate-pulse">GitHub</p>
  </a>
</div>
